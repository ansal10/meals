...
const USER_DETAILS_FIELDS = ['role', 'status', 'sex', 'name', 'email', 'id', 'calorieGoal', 'managerId', 'createdAt', 'updatedAt'];
...
const createUserInDatabase = async function (userParams) {
    ...
    try {
        ...
        let user = new models.User({
            ...
            passwordAttributes: {
                salt: uuid,
                hash: hashlib.sha256(userParams.password + uuid).digest('hex'),
            },
            sex: userParams.sex || '',
